...
//
//  Support for the find -inum option.
#define BB_FEATURE_FIND_INUM
//
// Support for the -A -B and -C context flags in grep
#define BB_FEATURE_GREP_CONTEXT	1
//
// Support for the EGREP applet (alias to the grep applet)
#define BB_FEATURE_GREP_EGREP_ALIAS	 1
#define BB_FEATURE_GREP_FGREP_ALIAS	 1
//
// Tell tftp what commands that should be supported.
#define BB_FEATURE_TFTP_PUT
#define BB_FEATURE_TFTP_GET
//
// Support for users in utmp
#define	BB_FEATURE_UPTIME_UTMP_SUPPORT
//
// features for vi
