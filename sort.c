...
static int CDECL compare_ascii(const void *x, const void *y)
{
	return strcmp(*(char **)x, *(char **)y);
}

static int CDECL compare_numeric(const void *x, const void *y)
{
...
int sort_main(int argc, char **argv)
{
	...
	int i, opt, nlines = 0;
	int (CDECL *compare)(const void *, const void *) = compare_ascii;
